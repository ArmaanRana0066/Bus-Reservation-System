...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Bus Reservation System</a>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome to my Bus Ticket Booking/Reservation System. Admin Panel for booking and managing whole system. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
            ...
            <br>
            <center>
            <a href="#pnr-enquiry"><button class="btn btn-warning">Scroll Down <i class="fa fa-arrow-down"></i></button></a>
            </center>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                <h1>About Us</h1>
                <h4>Tech Stack used in this Project</h4>
                <p>
                    Hi I am Shahika from BCA department of MPGC Amb. In this major project of BCA I have made a interactive Bus reservation system which will help to book tickets online in future. I have used HTML,CSS and Bootstrap for UI and at backend a MYSQL Database is linked using php to store and retrieve various information needed for this project.
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Bus Reservation Booking System | Made with &#10084;&#65039; by Shahika-22BCA005
                        </p>
        </footer>
    </div>
